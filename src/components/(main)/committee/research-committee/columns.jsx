...
export const ResearchColumns = [
  ...
  },
  {
    ...
    id: "actions",
    cell: ({ row }) => {
      const research_committee = row.original;
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <div className="flex gap-2 w-full">
              <Link to={`/research-committee/read/${research_committee.id}`}>
                <Eye />
              </Link>
              <Link to={`/research-committee/update/${research_committee.id}`}>
                <Edit />
              </Link>

              <DeleteModal
                path={`/api/research-committee/${research_committee.id}`}
              />
            </div>
          </DropdownMenuContent>
        </DropdownMenu>
