...
export const ResearchManagementColumns = [
  {
    accessorKey: "index",
  ...
  },
  {
    ...
    id: "actions",
    cell: ({ row }) => {
      const research_management = row.original;
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <div className="flex gap-2 w-full">
              <Link
                to={`/research-management/read/${research_management.id}`}
              >
                <Eye />
              </Link>
              <Link
                to={`/research-management/update/${research_management.id}`}
              >
                <Edit />
              </Link>

              <DeleteModal
                path={`/api/research-management/${research_management.id}`}
              />
            </div>
          </DropdownMenuContent>
        </DropdownMenu>
