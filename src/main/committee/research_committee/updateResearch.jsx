...
const UpdateResearch = () => {
  ...
  const submitFormData = async (formData, id) => {
    const response = await editData(`/api/research-committee/${id}`, formData);
  ...
  const {
    ...
    queryKey: ["research", id], // Ensure queryKey is an array
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success("Research committee Updated successfully");
